...
class OdometryPlotter(Node):
    ...
    def plot_path(self):
        ...
        plt.tight_layout()
        plt.savefig('/home/junninghuang//Desktop/Code/legged_odometry_py/img/kinematics-odom.png')
        plt.show()
    ...
    def plot_odom_path(self):
        ...
        plt.tight_layout()
        plt.savefig('/home/junninghuang//Desktop/Code/legged_odometry_py/img/vo-odom.png')
        plt.show()
    ...
    def plot_3d_path_kinematics(self):
        ...
        ax.set_zlim(0.0, 1.6)
        ax.legend()
        plt.savefig('/home/junninghuang//Desktop/Code/legged_odometry_py/img/3d-kinematics-odom.png')
        plt.show()
    ...
    def plot_3d_path_odom(self):
        ...
        ax.set_title('3D Odometry Path vs Ground Truth')
        ax.legend()
        plt.savefig('/home/junninghuang//Desktop/Code/legged_odometry_py/img/3d-vo-odom.png')
        plt.show()
    ...
    def plot_velocities(self):
        ...
        plt.tight_layout()
        plt.savefig('/home/junninghuang//Desktop/Code/legged_odometry_py/img/linear_velocities.png')
        plt.show()
    ...
    def plot_joint_velocities(self):
        ...
        for i in range(num_joints):
            ...
            plt.savefig(f'/home/junninghuang//Desktop/Code/legged_odometry_py/img/joint_velocity_{self.joint_names[i]}.png')
            plt.show()
